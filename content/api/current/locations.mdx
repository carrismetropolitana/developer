...
Regions are the top-level division in the API. At the moment there are 3 regions: `amL`, `Àlentejo Central` and `Oeste`. Regions are identified by their NUTS-III code.

Regions represent the top-level geographic division in the API. Currently, there are three regions available: **amL (Lisbon Metropolitan Area)**, **Alentejo Central** and **Oeste**.
Regions are identified using their NUTS-III code, ensuring consistency with established geographic standards.
