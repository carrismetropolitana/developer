...
This API provides scheduled and realtime data for Carris Metropolitana. If you are looking for a particular operators data please look at the following table:
